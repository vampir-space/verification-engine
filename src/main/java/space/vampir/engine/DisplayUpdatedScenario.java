...
public class DisplayUpdatedScenario {
    ...
    public static void main(String[] args) {
        ...
        referenceExample.put(0L, new Odometry(0L, 0, 0, 0,3));
        referenceExample.put(1L, new Odometry(1L, 0, 0, 0,3));
        referenceExample.put(2L, new Odometry(2L, 0, 0, 0,3));
        referenceExample.put(3L, new Odometry(3L, 0, 0, 0,3));
        referenceExample.put(4L, new Odometry(4L, 0, 0, 0,3));
        referenceExample.put(5L, new Odometry(5L, 0, 0, 0,3));
        referenceExample.put(6L, new Odometry(6L, 0, 0, 0,3));

        GNSS.put(0L, new Odometry(0L, 0.4, 0.4, 0,3)); //T
        GNSS.put(1L, new Odometry(1L, 1, 1, 0,3)); //F
        GNSS.put(2L, new Odometry(2L, 0.6, 0.6, 0,3)); //F
        GNSS.put(3L, new Odometry(3L, 2, 2, 0,3)); //F
        GNSS.put(4L, new Odometry(4L, 0.4, 0.4, 0,3)); //T
        GNSS.put(5L, new Odometry(5L, 2, 2, 0,3)); //F
        GNSS.put(6L, new Odometry(6L, 0.4, 0.4, 0,3)); //T

        verificationEngineExample.put(0L, new Odometry(0L, 0.3, 0.3, 0,3)); //T
        verificationEngineExample.put(1L, new Odometry(1L, 0.4, 0.4, 0,3)); //T
        verificationEngineExample.put(2L, new Odometry(2L, 1, 1, 0,3)); //F
        verificationEngineExample.put(3L, new Odometry(3L, 0.4, 0.4, 0,3)); //T
        verificationEngineExample.put(4L, new Odometry(4L, 1, 1, 0,3)); //F
